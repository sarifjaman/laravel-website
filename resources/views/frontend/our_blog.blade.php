                  ...
                  <div class="standard__blog__post">
                    ...
                    <div class="standard__blog__content">
                        <div class="blog__post__avatar">
                            <div class="thumb"><img src="{{ asset($item->blog_image) }}" width="35px" height="35px" alt=""></div>
                            {{-- <span class="post__by">By : <a href="#">Halina Spond</a></span> --}}
                        </div>
                        <h2 class="title"><a href="">{{ $item->blog_title }}</a></h2>
                        <p>{!! Str::limit($item->blog_description) !!}</p>
                        <ul class="blog__post__meta">
                            <li><i class="fal fa-calendar-alt"></i>{{ $item->created_at->format('d M, Y') }}</li>
                        </ul>
                    </div>
                  </div>
                  @endforeach
                        ...
                        <ul class="rc__post">
                            ...
                            <li class="rc__post__item">
                                ...
                                <div class="rc__post__content">
                                    ...
                                    <span class="post-date"><i class="fal fa-calendar-alt"></i> {{ Str::limit($item->created_at->format('d M, Y') ) }}</span>
                                </div>
                            </li>
                            @endforeach
                    ...
                    <div class="widget">
                        ...
                        <ul class="sidebar__cat">
                            ...
                            @foreach($recentblog as $item)
                                 <li class="sidebar__cat__item"><a href="{{ route('categories.blog',$item->id) }}">{{ $item->blog_category }}</a></li>
                            @endforeach
