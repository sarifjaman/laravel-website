                        ...
                        <nav class="menu__nav">
                            ...
                            <div class="navbar__wrap main__menu d-none d-xl-flex">
                                <ul class="navigation">
                                    ...
                                    <li class="menu-item-has-children {{ ($route == 'portfolio.home') ? 'active' : '' }}"><a href="{{ route('portfolio.home') }}">Portfolio</a></li>
                                    <li class="menu-item-has-children {{ ($route == 'our.blog') ? 'active' : '' }}"><a href="{{ route('our.blog') }}">Our Blog</a></li>
