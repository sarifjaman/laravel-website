<section class="portfolio">
    ...
    @php
        $showportfolio = App\Models\Portfolio::latest()->get();
    @endphp
                        ...
                        <div class="portfolio__active">
                            ...
                            <div class="portfolio__item">
                                ...
                                <div class="portfolio__overlay__content">
                                    ...
                                    <h4 class="title"><a href="{{ route('portfolio.detail',$item->id) }}">{{ $item->portfolio_title }}</a></h4>
