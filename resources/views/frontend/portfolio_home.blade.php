                ...
                <div class="row gx-0 align-items-center">
                    ...
                    <div class="col-lg-6 col-md-10">
                        <div class="portfolio__inner__content">
                            <h2 class="title"><a href="{{ route('portfolio.detail',$item->id) }}">{{ $item->portfolio_title }}</a></h2>

                            <p>{!!  substr(strip_tags($item->portfolio_description), 0, 150) !!}</p>
                            <a href="{{ route('portfolio.detail',$item->id) }}" class="link">View Case Study</a>
                        </div>
                    </div>
                </div>
            </div>
