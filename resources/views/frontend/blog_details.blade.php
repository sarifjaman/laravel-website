                ...
                <div class="standard__blog__post">
                    ...
                    <div class="blog__details__content services__details__content">
                        <ul class="blog__post__meta">
                            <li><i class="fal fa-calendar-alt"></i> {{ $blogs->created_at->format('dM,Y')}}</li>
                        </ul>
                        ...
                        <ul class="rc__post">
                            ...
                            <li class="rc__post__item">
                                ...
                                <div class="rc__post__content">
                                    ...
                                    <span class="post-date"><i class="fal fa-calendar-alt"></i>{{ $blog->created_at->format('d M, Y') }}</span>
                                </div>
                            </li>
                            @endforeach
                    ...
                    <div class="widget">
                        ...
                        <ul class="sidebar__cat">
                            ...
                            @foreach($categories as $cat)
                                <li class="sidebar__cat__item"><a href="{{ route('categories.blog',$cat->id) }}">{{ $cat->blog_category }}</a></li>
                            @endforeach
