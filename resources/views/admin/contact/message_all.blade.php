 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">All Message Page</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
              <li class="breadcrumb-item active">All Message Data</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                    ...
                    <div class="card-body">
                      ...
                      @foreach($allmessage as $item)
                        <tr class="odd">
                          ...
                          <td>{{ $item->phone }}</td>
                          <td>
                            <a href="{{ route('show.message',$item->id) }}" class="btn btn-primary" title="show"><i class="fas fa-eye"></i></a>
                            <a href="{{ route('delete.message',$item->id) }}" class="btn btn-danger" title="delete" id="delete"><i class="fas fa-trash-alt"></i></a>
                          </td>
                        </tr>
                      @endforeach
