            ...
            <div class="col-md-12">
                    ...
                    <div class="card-body">
                      <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        ...
                        <tr>
                            ...
                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Blog Category</th>
                            <th>Blog Title</th>
                            <th>Blog Tags</th>
                            <th>Blog Image</th>
                ...
                @foreach($allblog as $item)
                        <tr class="odd">
                          ...
                          <td>
                            <img src="{{ asset($item->blog_image) }}" width="100px" class="img-fluid" />
                        </td>
                          <td>{{ Str::limit($item->blog_description,100) }}</td>
                          <td>
                            <a href="{{ route('edit.blog',$item->id) }}" class="btn btn-primary" title="edit"><i class="fas fa-edit"></i></a>
                            <a href="{{ route('delete.blog',$item->id) }}" class="btn btn-danger" title="delete" id="delete"><i class="fas fa-trash-alt"></i></a>
                          </td>
                        </tr>
                   @endforeach
                    ...
                    <div class="col-sm-6 col-md-6" >
                        <div class="dataTables_paginate paging_simple_numbers" id="example1_paginate">
                            <ul class="pagination" style="margin-right: 0px!important;">
                                <li class="paginate_button page-item previous disabled" id="example1_previous" style="margin-left: 117px;">
